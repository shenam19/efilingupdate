<div>
    ...
    <div wire:ignore class="modal fade" id="attach-files" tabindex="-1" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-xl">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" wire:click="attach"
                        onclick="closeAttachModal()">བསྒྱུར་བ་གསོག་འཇོག་བྱོས།</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <script>
            ...
            Dropzone.options.mediaDropzone = {
                ...
                success: function(file, response) {
                    ...
                    // Livewire.dispatch("setSelectedMedia").to("attach-media", arr);
                    // Livewire.dispatch('setSelectedMedia', {
                    //     selectedMedia: arr
                    // }).to('attach-media');
                    Livewire.dispatchTo('setSelectedMedia', 'attach-media', {
                        selectedMedia: arr
                    });
