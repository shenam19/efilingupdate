            ...
            @if ($file)
                <div class="card-header bg-light d-flex justify-content-between">
                    <div class="card-title flex-grow-1">{{ $file['file_no'] . ' ' . $file['name'] }}
                        ...
                        <x-date-range-picker-modal :route="route('folder.print', $file['id'])" :title="'Select which date to print records'" />

                    </div>
                    <div class="card-menu d-flex">

                        <button class="btn btn-link text-secondary p-0 mr-2" data-toggle="modal"
                            data-target="#editFile"><i class="fas fa-pen"></i></button>
                        <button class="btn text-secondary p-0 mx-2" data-toggle="modal"
                            data-target="#showRecordLists"><i class="fas fa-plus-circle"></i></button>
        ...
        <div class="col">
            @if ($file)
                <div class="form-row pt-2 d-flex justify-content-start px-2">
                    ...
                    <div class="col-2">
                        <div class="form-group">
                            <select class="form-control" wire:model.live="fiscalYear">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <input type="date" class="form-control input-sm " wire:model.live="date">
                        </div>
                    </div>
                    <div class="col-3">
                        <div class="form-search">
                            <i class="fa fa-search"></i>
                            <input type="text" class="form-control form-input" placeholder="འཚོལ།"
                    ...
                    <div class="modal-body">
                        <div class="form-row">
                            ...
                            <div class="col-4">
                                ...
                                <input type="date" class="form-control" placeholder="འདིར་འབྲི་རོགས།"
                                    name="date_opened" value="{{ $file?->date_opened }}">
                            </div>
