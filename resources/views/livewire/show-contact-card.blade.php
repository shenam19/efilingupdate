                ...
                <div class="member-card pt-4 pb-2">
                    <div class="">
                        ...
                        <p class="text-muted ">
                            ...
                            <span>| </span>
                            <span class="text-primary"><i class="fas fa-envelope"></i>
                                {{ $contact->email ?? '------' }}</span>
                        </p>
                        ...
                        <div class="modal-body">
                            @if ($contact->message->count() || $contact->recipient->count())
                                <div class="form-group">
                                    <label>{{ $contact->name }} has sent {{ $contact->message->count() }} messages and
                                        has had
                                    ...
                                    <x-dropdown :option="$contactsTree" name="transferContact" id="transferContactTo"
                                        :multiple="false" :multiSelect="0"
