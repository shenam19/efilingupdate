<div class="container-fluid py-2">
    <div class="nav nav-tabs nav-fill w-50" id="nav-tab" role="tablist">
        <a wire:click="$set('type','mine')"class="nav-item nav-link {{ $type === 'mine' ? 'active' : ''}}" id="nav-home-tab" data-toggle="tab" href="#my-media" role="tab" aria-controls="nav-home" aria-selected="true">ངའི་ཡིག་པར།</a>
        <a wire:click="$set('type','shared')"class="nav-item nav-link {{ $type === 'shared' ? 'active' : ''}}" id="nav-profile-tab" data-toggle="tab" href="#shared-media" role="tab" aria-controls="nav-profile" aria-selected="false">ང་ལ་བརྒྱུད་སྤེལ་བྱས་པ།</a>
    </div>
            ...
            @if($type === 'shared')
                <div class="col-3 px-3 pt-2">
                    <div class="form-group">
                        ...
                        <select class="form-control" wire:model="sharedBy">
    ...
    <!------- Edit Media Modal  ------->
    <div wire:ignore class="modal fade" id="edit_media" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" data-dismiss="modal" wire:click="edit()">Save changes</button>
                </div>
            </div>
        </div>
    </div>
