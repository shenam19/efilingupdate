                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="reason" class="form-control" id="reason-text"
                                            placeholder="ཕྱིར་འཐེན་བྱེད་དགོས་པའི་རྒྱུ་མཚན་འགོད་རོགས།"
                                        ...
                                        <div class="input-group mb-2 mr-sm-2">
                                            <div class="input-group-prepend" style="width:40%">
                                                <input type="number" class="input-group-text form-control"
                                                    name="record[outgoing_no]" value="{{$message->record->outgoing_no}}" disabled>
                                            </div>
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <textarea id="remarks" class="form-control" rows="3"
                                            placeholder="འདིར་འབྲི་རོགས།" name="remarks"
                                ...
                                <div class="col-2">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="urgency" id="urgency">
                                            <option value="gray"   @if($message->urgency==='gray') selected @endif>གལ་ཆུང་བ།</option>
                                            <option value="yellow" @if($message->urgency==='yellow') selected @endif>གལ་འབྲིང་བ།</option>
                                            <option value="orange" @if($message->urgency==='orange') selected @endif>གལ་ཆེ་བ།</option>
