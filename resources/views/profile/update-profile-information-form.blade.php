<x-jet-form-section submit="updateProfileInformation">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-4">
                <x-slot name="title">
                  <div  data-toggle="tooltip" data-placement="top" title="profile information">  {{ __('ངོ་སྤྲོད་གནས་ཚུལ།') }} </div>
                </x-slot>
                    ...
                    @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                        <div x-data="{photoName: null, photoPreview: null}" class="col-md-6 sm:col-span-4 p-4">
                            ...
                            <div class="mt-2" x-show="! photoPreview">
                                <img src="{{ $this->user->profile_photo_url }}" alt="{{ $this->user->name }}" class="rounded-circle w-25">
                            </div>
